...
$"??_C@_06GANFPHOD@hello?$CB?$AA@" = comdat any

@"??_C@_06GANFPHOD@hello?$CB?$AA@" = linkonce_odr dso_local unnamed_addr constant [7 x i8] c"hello!\00", comdat, align 1
...
define dso_local i32 @main() #1 {
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"??_C@_06GANFPHOD@hello?$CB?$AA@", i64 0, i64 0))
  ret i32 0
}
